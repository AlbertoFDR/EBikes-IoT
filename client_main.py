...
WEATHER_SENSOR_DHT = str(os.getenv("WEATHER_SENSOR_DHT"))
WEATHER_SENSOR_PIN = os.getenv("WEATHER_SENSOR_PIN")
GAS_SENSOR_CHANNEL = os.getenv("GAS_SENSOR_CHANNEL")
LOUDNESS_SENSOR_CHANEEL = os.getenv("LOUDNESS_SENSOR_CHANEEL")
